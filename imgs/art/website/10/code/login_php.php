...
<h3 class="program-title">PROGRAM IN ACTION</h3>
<div class="programinaction">
<?php include 'c_login1_php.php' ?>
</div>

<h3 class="code-title">CODE for login1.php</h3>
<div class="code">
<?php
echo highlight_file('c_login1_php.php', true);
?>
</div>

<h3 class="code-title">CODE for login2.php</h3>
<div class="code">
<?php
echo highlight_file('c_login2_php.php', true);
?>
</div>
